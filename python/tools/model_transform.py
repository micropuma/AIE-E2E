...
class ModelTransformer(object):
    ...
    def model_transform(self, mlir_file: str, add_postprocess: str="", patterns_count: dict={}):
        ...
        # 目前已经介入mlir系统了，利用python binding对mlir做pass pipeline
...
class OnnxTransformer(ModelTransformer):
    ...
    # 借助于onnx的runtime，做inference，这个inference是作为基准
...
if __name__ == '__main__':
    ...
    # 调用model transform
    # 这里可以借鉴onnx的transform
    tool = get_model_transform(args)
    # args.mlir是transform之后生成的文件路径，postprocess是预处理函数，
