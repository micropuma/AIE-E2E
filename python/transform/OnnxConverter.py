...
class OnnxConverter(BaseConverter):
    ...
    def generate_mlir(self, mlir_file: str):
        ...
        # input op例子：
        # %1 = "top.Input"(%arg0)
        # {channel_format = "nchw", do_preprocess = true, keep_aspect_ratio = true, keep_ratio_mode = "letterbox", mean = [0.000000e+00, 0.000000e+00, 0.000000e+00],
        # pad_type = "center", pad_value = 0 : i64, pixel_format = "rgb", resize_dims = [640, 640],
        # scale = [0.0039216000586748123, 0.0039216000586748123, 0.0039216000586748123]} : (tensor<1x3x640x640xf32>) -> tensor<1x3x640x640xf32> loc(#loc1)
        # add input op
        input_data = None
